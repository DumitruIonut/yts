...
class _$MovieTearOff {
  ...
  Movie$ call({required int id, required String title}) {
    return Movie$(
      id: id,
      title: title,
    );
...
class _$Movie$ implements Movie$ {
  const _$Movie$({required this.id, required this.title});
...
abstract class Movie$ implements Movie {
  const factory Movie$({required int id, required String title}) = _$Movie$;
